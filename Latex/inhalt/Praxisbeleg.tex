...
\bild[0.8]{architektur}{Grobe Systemarchitektur der Kundendatenverwaltung}{fig:architektur}
...
\bild[0.7]{frontend}{Screenshot der Benutzeroberfläche (Maske Kundendaten)}{fig:frontend}
...
\bild[0.6]{security}{Schematischer Ablauf der JWT-Authentifizierung}{fig:security}
