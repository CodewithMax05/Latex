...
\bild[0.6]{fastapi_swagger}{Automatische API-Dokumentation der Kundendaten-Schnittstelle}{fig:fastapi}
...
\bild[0.6]{flutter_ui}{Benutzeroberfläche der Verwaltungs-App unter Windows}{fig:flutter}
